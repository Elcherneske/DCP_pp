    ...
    for epoch in range(num_epochs):
        ...
        for n_batch, (src, tar, R_gt, t_gt, src_file) in enumerate(test_loader):
            ...
            generalized_icp = o3d.pipelines.registration.registration_generalized_icp(
                ...
                criteria=o3d.cuda.pybind.pipelines.registration.ICPConvergenceCriteria(max_iteration=35))  # 设置最大迭代次数
            ...
            transform = torch.tensor(generalized_icp.transformation).unsqueeze(0)
